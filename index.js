...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'docker.gikgwongsblog.ccwu.cc';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiM2Y3ZTU0NzNmZjA5NWZmNGNjZWZlNTNhNDZmNTUxYjUiLCJ0IjoiYmE0MTA4YzEtNGI1My00OWIxLWFkODYtNTFiNWNlZWYxNjU4IiwicyI6Ik9ESTNaakptWW1JdFpqWmpNaTAwWWpnMUxXRTVaRGt0WWpSbU16QXpOelF5WXpZMiJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
const ARGO_PORT = process.env.ARGO_PORT || 8001;            // 固定隧道端口,使用token需在cloudflare后台设置和这里一致
const CFIP = process.env.CFIP || 'saas.sin.fan';            // 节点优选域名或优选ip  
const CFPORT = process.env.CFPORT || 443;                   // 节点优选域名或优选ip对应的端口
const NAME = process.env.NAME || 'mydckgm143';                        // 节点名称
